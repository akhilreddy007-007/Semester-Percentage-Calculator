...
public class Test7 extends Test6{
	...
	public void disp() {
		super.disp();
				...
				System.out.println("enter grades for 7th sem");
...
//			System.out.println("your total marks for 1000 in 1 is "+a1);
			...
			System.out.println("your total marks for 1000 in 7th sem is "+a1);
			System.out.println("3rd sem percentage is "+b+"%");
			System.out.println("percentage of 1st & 2nd & 3rd & 4th & 5th & 6th & 7th sem is "+result+"%");
