...
public class Test5 extends Test4{
	...
	public void disp() {
		super.disp();
				...
				System.out.println("enter grades for 5nd sem");
...
//			System.out.println("your total marks for 1000 in 1 is "+a1);
			...
			System.out.println("your total marks for 1000 in 5th sem is "+a1);
			System.out.println("3rd sem percentage is "+b+"%");
			System.out.println("percentage of 1st & 2nd & 3rd & 4th & 5th sem is "+result+"%");
